    ...
    public sealed class CementProjectPackage : Package
    {
        ...
        protected override void Initialize()
        {
            ...
            if ( null != mcs )
            {
                ...
                CommandID menuCommandID = new CommandID(GuidList.guidCement_VisualStudio_ProjectCmdSet, (int)PkgCmdIDList.cmdidCementCommand);
